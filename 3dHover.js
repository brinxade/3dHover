        ...
        $.fn.mouseHover3d = function(givenSettings) {
            ...
            return containers.each((index)=>{
                ...
                function bendBox(elem){
                    ...
                    //console.log(`GradAngle: ${gradAngle} Angle: ${angleX} ${angleY} Offset: ${offsetX} ${offsetY}`);
                    //console.log(`CLR1: ${clr1}  CLR2: ${clr2}`);
                ...
                function restoreBox(elem)
                {
                    ...
                    const elementToTransform=elem.find(innerContainerClass);
                    //console.log(`Power: ${power} GradAngle: ${gradAngle} TimeElapsed: ${timeElapsed}`);
